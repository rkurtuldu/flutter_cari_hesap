...
class Satis extends ConsumerStatefulWidget {
  const Satis({Key? key}) : super(key: key);

  @override
  ConsumerState createState() => _SatisState();
}

class _SatisState extends ConsumerState<Satis> {
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    onTap: () async {
                      ...
                      if (pickedDate != null) {
                        final saat = DateFormat("HH.mm").format(DateTime.now());
                  ...
                  TextFormField(
                    ...
                    onSaved: (newvalue) {
                      girilen["satistutari"] = double.parse(newvalue!);
                    },
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (formState.validate() == true) {
                          ...
                          girilensatis = girilen["satistutari"];
                          gidenbakiye = (gelenbakiye + girilensatis);
                          girilen["tahsilattutari"] = 0.0;
